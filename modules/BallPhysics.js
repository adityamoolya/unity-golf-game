...
export class BallPhysics {
  constructor(scene, gameState, courseBuilder) {
    ...
    // Hide trajectory if course config disables it (e.g., hard mode)
    if (this.gameState && this.gameState.courseConfig && this.gameState.courseConfig.disableTrajectory && this.trajectoryLine) {
...
showAimingElements() {
  ...
  if (this.aimArrow) this.aimArrow.visible = true;
    if (this.trajectoryLine) {
      const disableTrajectory = this.gameState && this.gameState.courseConfig && this.gameState.courseConfig.disableTrajectory;
      this.trajectoryLine.visible = !disableTrajectory;
    }
