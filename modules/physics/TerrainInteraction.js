...
export class TerrainInteraction {
  ...
  visualizeHazardBoundary(hazard, color) {
    if (hazard.pathStart && hazard.pathEnd) {
      ...
      // Draw inner boundary
      const innerWidth = hazard.type === 'standardRough' ? this.courseBuilder.courseConfig.fairwayWidth / 2 : hazard.standardRoughWidth;
                       
      // Draw outer boundary
      const outerWidth = hazard.type === 'standardRough' ? hazard.roughHalfWidth : hazard.outerRoughWidth;
